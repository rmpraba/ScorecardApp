...
app.post('/fmailreportcard-service' ,  urlencodedParser,function (req, res)
{
    ...
    console.log(req.query.schoolname+"   "+req.query.academicyear); 
    console.log('.......................................................');
  var header="<div class='bbox' id='fivescorecard'><div class='relative'><table border='0' class='scoretbl'><tr><th colspan='3'><h2><center>"+req.query.schoolname+"</center></h2></th>"
  ...
  var performanceprofile="<div class='absolute'><img src=‘../../images/zeesouth.png’ height='100px' width='90px'/></div><div class='pr'><center><h2>PERFOMANCE PROFILE</h2>"
  ...
  var attendance="<table border='1' class='attable'><tr><th colspan='3' >Attendence:</th><th colspan='10'>Term1</th><th colspan='3'>Term2</th>"
...
var photo="<div class='pto'><h4>Student photo with signature</h4><br><p>(Attested by the Schoolprincipal along with school seal) </p></div></div>"

var scholasticvalue="<div class='bbbox'><table border='1'><tr><th colspan='16'> <h2>PART1-ACADEMIC PERFOMANCE: Scholastic Areas</h2><br> "   
